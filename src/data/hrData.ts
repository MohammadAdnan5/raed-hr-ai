...
export const pendingApprovals: HRRequest[] = [
  ...
  },
  {
    ...
    aiSummary: "خالد استنفد رصيد العمل عن بُعد لهذا الشهر (٤/٤). كما أن لديه اجتماع مراجعة ربعي مجدول حضورياً في نفس اليوم — أنصح بالمراجعة قبل القرار.",
    aiRecommendation: "review",
    aiReasoning: [
      "رصيد العمل عن بُعد: ٠ يوم متبقٍ هذا الشهر ⚠️",
      "اجتماع مراجعة ربعي حضوري مجدول في نفس اليوم ⚠️",
      "أداء آخر ٣٠ يوم: ضمن المتوسط ✓",
      "السياسة (المادة ٢): تجاوز الحد يحتاج موافقة المدير المباشر",
    ],
  },
  {
    id: "REQ-2047",
...
export const initialTrackedDocs: TrackedDocument[] = [
  {
    id: "DOC-2039",
    type: "شهادة خبرة",
    recipient: "للتقديم على وظيفة جديدة",
    requestedAt: "أمس",
    status: "delivered",
    steps: [
      { label: "استلام الطلب", done: true },
      { label: "حساب مدة الخدمة (٣ سنوات و٤ أشهر)", done: true },
      { label: "اعتماد المدير المباشر", done: true },
      { label: "التوقيع الرقمي من HR", done: true },
      { label: "تم التسليم", done: true },
    ],
  },
  {
    id: "DOC-2036",
    type: "تأشيرة خروج وعودة",
    recipient: "إجازة عائلية إلى تركيا",
    requestedAt: "قبل يومين",
    status: "delivered",
    steps: [
      { label: "استلام الطلب", done: true },
      { label: "ربط الطلب بأبشر أعمال", done: true },
      { label: "إصدار التأشيرة", done: true },
      { label: "تم التسليم", done: true },
    ],
  },
  {
    id: "DOC-2034",
    type: "خطاب عدم ممانعة",
    recipient: "لاستخراج رخصة عمل حر",
    requestedAt: "قبل ٣ أيام",
    status: "delivered",
    steps: [
      { label: "استلام الطلب", done: true },
      { label: "مراجعة سياسة العمل الحر", done: true },
      { label: "اعتماد المدير و HR", done: true },
      { label: "تم التسليم", done: true },
    ],
  },
  {
    id: "DOC-2030",
    type: "كشف رواتب آخر ٣ شهور",
    recipient: "السفارة الأمريكية — طلب تأشيرة",
    requestedAt: "الأسبوع الماضي",
    status: "delivered",
    steps: [
      { label: "استلام الطلب", done: true },
      { label: "تجميع كشوف يناير–مارس", done: true },
      { label: "ختم HR رقمياً", done: true },
      { label: "تم التسليم", done: true },
    ],
  },
];
